...
<div class="container">
    <div class="mx-auto" style="width: 60%">
        <div id="box" class="panel panel-default" style= "border-color: skyblue" >
            <div>
                <form action="sign-up" method="post">
                    ...
                    <div class="form-group">
                        <div style="width: 50%">
                            <label class="radio-inline"><strong>Gender:</strong></label>
                            Female<input  type="radio" value="0" name="gender">
                            Male<input  type="radio" value="1" name="gender">
                            Other<input  type="radio" value="2" name="gender">
                            <br><br>
                        </div>
                    </div>
